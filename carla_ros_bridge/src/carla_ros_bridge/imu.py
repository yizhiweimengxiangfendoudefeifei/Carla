...
class ImuSensor(Sensor):
    ...
    def __init__(self, uid, name, parent, relative_spawn_pose, node, carla_actor, synchronous_mode):
        ...
        self.imu_publisher = node.new_publisher(Imu, self.get_topic_prefix(), qos_profile=10)#/carla/ego_vehicle/imu
        self.listen()
    ...
    def sensor_data_updated(self, carla_imu_measurement):
        ...
        # print("ax = %f ay = %f az = %f"%(imu_msg.linear_acceleration.x, imu_msg.linear_acceleration.y, imu_msg.linear_acceleration.z))
        # print("ax = %f"%(imu_msg.linear_acceleration.x * math.cos(yaw) - imu_msg.linear_acceleration.y * math.sin(yaw)))
        # print("ay = %f"%(imu_msg.linear_acceleration.y * math.cos(yaw) + imu_msg.linear_acceleration.x * math.sin(yaw)))
