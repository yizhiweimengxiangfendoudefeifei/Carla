...
class EgoVehicle(Vehicle):
    ...
    def send_vehicle_msgs(self, frame, timestamp):
        ...
        if not self.vehicle_info_published:
            ...
            # front_wheel_position = vehicle_info.wheels[0].position
            # rear_wheel_position = vehicle_info.wheels[-1].position
            # wheelbase = abs(front_wheel_position.x - rear_wheel_position.x)
            # wheeldis = abs(front_wheel_position.y - rear_wheel_position.y)
            # print(front_wheel_position.x)
            # print(rear_wheel_position.x)
            # print("wheelbase = %f"%(wheelbase))
            # print("wheeldis = %f"%(wheeldis))
